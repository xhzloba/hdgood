...
export default function VenomFranchisePage() {
  const apiUrl = "/api/franchise-venom";
  const backdropUrl = "/movies/venom-franshise.jpg";
  const logoUrl = "/movies/logo/venom-logo.png";
              ...
              <div className="-mx-5 px-5 pt-0 pb-3">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    Карточки частей и продолжений по вселенной Венома.
                  </p>
                </div>
              </div>
              <div className="mt-4">
