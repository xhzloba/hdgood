...
function CarouselPrevious({
  ...
  return (
    <button
      ...
      className={cn(
        'absolute z-20 inline-flex items-center justify-center w-9 h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 xl:w-12 xl:h-12 rounded-full border border-white/70 bg-white text-black shadow-md hover:shadow-lg hover:bg-white/95 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
        orientation === 'horizontal'
          ? 'top-[40%] md:top-[41%] lg:top-[42%] xl:top-[43%] -translate-y-1/2 -translate-x-1/2 left-[-6px] md:left-[8px] lg:left-[14px] xl:left-[18px]'
  ...
  return (
    <button
      ...
      className={cn(
        'absolute z-20 inline-flex items-center justify-center w-9 h-9 md:w-10 md:h-10 lg:w-11 lg:h-11 xl:w-12 xl:h-12 rounded-full border border-white/70 bg-white text-black shadow-md hover:shadow-lg hover:bg-white/95 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
        orientation === 'horizontal'
          ? 'top-[40%] md:top-[41%] lg:top-[42%] xl:top-[43%] -translate-y-1/2 translate-x-1/2 right-[-6px] md:right-[8px] lg:right-[14px] xl:right-[18px]'
